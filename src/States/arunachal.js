...
function arunachal () {
  const images = [
    { url: "images/arunachal/jowar.jpeg" },
    { url: "images/arunachal/maize.jpg" },
    { url: "images/arunachal/oilseeds.jpg" },
    { url: "images/arunachal/rice.jpg" },
    { url: "images/arunachal/pulses.jpg" },
    { url: "images/arunachal/ragi.jpeg" },
  ];
    ...
    <div>
        ...
        <div class="dropdown">
          <button class="button button1">Arunachal pradesh</button>
        ...
        <div class="dropdown">
          <button class="button button1">Major Producing Crops in Arunachal pradesh</button>
        </div>
        </div>
        <div className="container">
             <img src="images/arunachal/arunachal.png"></img>
             <SimpleImageSlider
              width={700}
              height={500}
              images={images}
