...
function Karnataka() {
  const images = [
    ...
    <div>
        ...
        <div class="dropdown">
          <button class="button button1">Karnataka</button>
        ...
        <div class="dropdown">
          <button class="button button1">Major Producing Crops in karnataka</button>
        </div>
        </div>
        <div className="container">
             <img src="images/andhra_pradesh/karnataka.jpg"></img>
             <SimpleImageSlider
              width={700}
              height={500}
              images={images}
